...
5. **If 3+ Fixes Failed: Question Architecture**
   ...
   **Escalate to the team lead before attempting more fixes**
...
**But:** Based on observed debugging sessions, the vast majority of "no root cause" cases are incomplete investigation.
...
**Related skills:**
- **`tdd`** skill - For creating failing test case (Phase 4, Step 1)
- **`verification-before-completion`** skill - Verify fix worked before claiming success

## Real-World Impact

Estimated from observed debugging sessions:
- Systematic approach: 15-30 minutes to fix
- Random fixes approach: 2-3 hours of thrashing
- First-time fix rate: significantly higher with systematic approach
- New bugs introduced: Near zero vs common

## Supporting Files

- `supporting-files/root-cause-tracing.md` — Backward tracing technique for deep call stacks
